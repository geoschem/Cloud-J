...
Recommendation (as of 21 Nov 2016):

        Implement ver 7.4 Cloud-J if you want compatibility with Solar-J versions to be released in 2016.
              v7.4d corrects solar flux deposition in each layer for SZA>90, i.e., heating rates.
        ...
        Implement ver 7.3d Cloud-J, skip ver 7.2, use the new data formats.
...
UCI_CloudJ74d.zip
        Corrected flux deposition error for SZA >90.  Added driver for running thru SZAs.
...
UCI_CloudJ73c-f90.zip
        Is a standalone NEW cloud overlap code matches Prather 2015 GMDD paper.
