...
!!!! IN !!!!
! CLDFLAG read in, type of cloud overlap parameterization:
...
!* NRANDO read in, # of random selections of ICAs to get average used for CLDFLAG=5
...
! # these are for diagnostics of the Cloud-J caculation, not needed unless there is trouble


!!!!  Key variables/parameters used in Cloud-J that are setup in FJX_INIT_MOD.F90
...
!        18     NWBIN  # wavelength bins in uv-vis for J's <<< can be 8 or 12 also for trop only J's
...
!         1     ATM0  Option for spherical corrections: 0=flat 1=sphr 2=refr 3=geom
...
!         7     CLDFLAG = recommended value for best results
